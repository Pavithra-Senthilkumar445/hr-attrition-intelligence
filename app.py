    ...
    return html.Div([
        html.Div([
            ...
            dbc.Modal([
                ...
                dbc.ModalBody([
                    html.P([html.Strong("Dataset: "), "IBM HR Analytics Employee Attrition & Performance"]),
                    html.P([html.Strong("Source: "), "Kaggle - IBM HR Analytics Employee Attrition Dataset"]),
                    html.P([html.Strong("Purpose: "), "Created by IBM data scientists to understand what factors lead to employee attrition."]),
                    html.P([html.Strong("Size: "), "1,470 employees x 35 attributes"]),
                    ...
                    html.Ul([
                        ...
                        html.Li("Years at Company - how long the employee has worked here"),
                        html.Li([
                    ...
                    dbc.Alert("Dataset Source: IBM HR Analytics Employee Attrition Dataset", color="info")
                ]),
...
def login_layout(theme="light"):
    ...
    return html.Div([
        html.Div([
            html.A(
                [html.I(className="bi bi-arrow-left me-2"), "Back to Home"],
                href="/",
                style={
                    "color": t["muted"],
                    "textDecoration": "none",
            ...
            html.H4("HR Attrition Intelligence Portal", style={
                "fontWeight": "600",
                "color": t["text"],
                "marginBottom": "4px"
            }),
...
def dashboard_layout(user, theme="light", age_filter="All", active_dept="All"):
    t = THEMES[theme]
    role = user["role"]
    ...
    fig_dept.update_xaxes(title="Attrition Rate (%)", range=[0, max(30, dept_max + 5)])
    ...
    insights_section = html.Div([
        html.H5([
            html.I(className="bi bi-lightbulb-fill me-2", style={"color": "#F0A500"}),
            "Key Insights"
    ...
    modal = dbc.Modal([
        ...
        dbc.ModalBody(dcc.Graph(id="modal-chart", config=CFG, style={"height": "500px"})),
    ...
    return html.Div([
            ...
            dbc.Container([
                html.Div([
                    html.Div([
                        ...
                        html.Span("HR Attrition Intelligence Portal", style={
                            "fontWeight": "600",
                            "color": t["text"],
                            "fontSize": "15px"
                        }),
                    ...
                    html.Div([
                        html.Span([
                            html.I(className="bi bi-person-circle me-2", style={
                                "fontSize": "18px",
                                "color": t["text"]
                            }),
                            html.Strong(role, style={"color": t["text"], "fontSize": "14px"})
        ...
        dbc.Container([
            dbc.Alert([
                ...
                f"Viewing {dept} department - {data['total_employees']} employees in scope."
...
def render_page(pathname, theme, age_f, dept_f, user):
    ...
    if pathname == "/dashboard" and active_user:
    ...
    if pathname == "/dashboard" and not active_user:
        return login_layout(theme)
...
def toggle_theme(is_dark, current_theme):
    ...
    if new_theme == (current_theme or "light"):
        return no_update
...
def open_modal(d_c, a_c, i_c, s_c, is_open, user, theme, age_f, dept_f):
    ...
    if triggered == "chart-sat" and s_c:
        ...
        fig = px.bar(
            ...
            barmode="group",
            color_discrete_map={
                "total_employees": "#4285F4",
                "attrition_count": "#DB4437"
            },
            labels={
